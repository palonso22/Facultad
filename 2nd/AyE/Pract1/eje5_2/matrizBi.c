...
Matriz* matriz_crear(size_t cantFilas,size_t cantCol){
	...
	MatrizBi* estructMatriz=malloc(sizeof(Matriz));
	//Def VI
	int i;
...
void matriz_mostrar(MatrizBi* estructMatriz){
...
void matriz_escribir(Matriz* estructMatriz, int posFil, int posCol, float dato){
...
void matriz_intercambiar_fila(MatrizBi* estructMatriz, int filaI, int filaJ){
...
void matriz_destruir(MatrizBi* estructMatriz){
...
MatrizBi* matriz_producto(MatrizBi* estructMatrizBiA,MatrizBi* estructMatrizBiB){
