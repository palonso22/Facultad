...
/*Permite manipular comandos a funciones
comandos:char*->int->int->void*/
aGList comandos(char* comando,int arg1, int arg2, aGList aListas);

/*Crea un arreglo de listas
comandos_crear_listas:size_t->GList**/
